...
<div class="rectangle_2">
    ...
    <div class='currency-list-block'>
        ...
        <div id="example-curr" class='currency-element first-currency-none first-currency-show-nal'>
            <div class="currency-element-block"></div>
...
//                let citiesMain = ['Москва', 'Санкт-Петербург'];
//                let newArr1 = [];
//                citiesMain.forEach((elm, ind) => {
//                    let adding = newArr.filter(x => x.city == elm);
//                    newArr1.push(adding[0]);
//                });
//                newArr.forEach((el, ind) => {
//                    if (!(citiesMain.includes(el.city))) {
//                        newArr1.push(el);
//                    }
//                });
                //
